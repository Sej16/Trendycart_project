...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251111_trendycart_a7222f53b44970b05062_20251111190420_archive.zip';
        const ARCHIVE_SIZE       = '123801976';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'a7222f5-11190420';
        const SECONDARY_PACKAGE_HASH = 'da9906a-11190420';
